...
void AIBlueMage::ApplyBehaviour(const WorldSnapshot &world, json::value params)
{
...
void AIBlueMage::InitializeTarget(Entity *target)
{
  this->target = target;
}
...
void AIBlueMage::InitilizeOwner(Entity *thisEntity)
{
  owner = thisEntity;
}
...
void AIBlueMage::MoveTowards(const WorldSnapshot &world)
{
