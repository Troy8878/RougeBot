...
public:
  inline ICamera *_GetICamera()
  {
    return _cameraPtr->GetCamera<ICamera>();
  }

  inline MultiCam &_GetMCamera()
  {
    return *_cameraPtr;
  }

  inline const std::type_index &_GetCameraType()
  {
    return _cameraPtr->type;
  }
};

// ----------------------------------------------------------------------------

class CameraComponentFactory final : public IComponentFactory
{
public:
